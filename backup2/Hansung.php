    ...
    function item($sort) {
        ...
        if($sort == "list") {
            while($row = mysqli_fetch_array($res)) {
                ...
                echo "</a>";
                echo "<p>".$title."<br>"."현재수량 : ".$amount."개</p>";
                echo "</div>";
            }
        } else if($sort == "detail") {
            while($row = mysqli_fetch_array($res)) {
				...
				if($_SESSION['login']==master) {		
					...
					echo "<input type='number' value='".$amount."' style='margin-top:2pt' id='amount' name='amount' aria-invalid='false'/>";
					echo "<button type='submit' style='padding-Top:5pt; padding-bottom:5pt; font-size:10pt; margin-left:5pt 'class='btn btn-success btn-lg; '>수정</button>";
					echo "</form>";
				}else{
                        ...
                        <div class="modal-body">
							...
							<div class="row">
								<div class="col-lg-8 col-lg-offset-2">
									...
									<form name="sentMessage" method ="post" enctype="multipart/form-data" action="upload.php" id="contactForm" novalidate="" >
										<div class="row control-group">
											<div
												class="form-group col-xs-12 floating-label-form-group controls">
												<label>물품명</label> <input type="text" class="form-control"
													placeholder="물품명" id="title" required="" name="title"
										...
										<div class="row control-group">
											<div
												...
												<label>물품 수량</label> <input type="number" class="form-control"
													placeholder="물품 수량" id="amount" required=""name = "amount"
										...
										<div class="row control-group">
											<div
												...
												<textarea rows="5" class="form-control" placeholder="물품소개를 입력하세요."
													id="content" required="" name = "content"
